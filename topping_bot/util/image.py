...
RESONANCE_FOLDER = {
    ...
    Resonance.ANCIENT_ROOT:    ("ancient_root",     _ALL_BASE_TYPES),
    ...
    Resonance.GAMBIT:          ("gambit",           _ALL_BASE_TYPES),
    Resonance.LIFE_ENERGY:     ("life_energy",      _ALL_BASE_TYPES),
    Resonance.LOOMING_DARK:    ("looming_dark",     _ALL_BASE_TYPES),
    Resonance.RESEARCH_DRIVEN: ("research-driven",  _ALL_BASE_TYPES),
    Resonance.UNISON:          ("unison",           _ALL_BASE_TYPES),
    Resonance.VERDIGRIS:       ("verdigris",        _ALL_BASE_TYPES),
}
